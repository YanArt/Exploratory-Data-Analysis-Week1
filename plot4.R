...
par(mfrow = c(2, 2))
plot(hh_power_cons2$datetime, hh_power_cons2$Global_active_power, type = "l", ylab = "Global Active Power", xlab = " ")
plot(hh_power_cons2$datetime, hh_power_cons2$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
plot(hh_power_cons2$datetime, hh_power_cons2$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
dev.off()